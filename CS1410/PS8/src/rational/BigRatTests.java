...
public class BigRatTests
{
    ...
    /**
     * checks for an illegalargument exception when a new bigrat is created using a long 0 in the denominator.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testExceptions1()
    {
        BigRat r1 = new BigRat(2, 0);
    }
    
    /**
     * checks for an illegalargument exception when a new bigrat is created using a bigInteger 0 in the denominator.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testExceptions2()
    {
        ...
        BigRat r1 = new BigRat(a, b);
    }
    
    /**
     * checks for an illegalargument exception when a new bigrat is dividing by bigrat with the value of 0
     */
    @Test(expected = IllegalArgumentException.class)
    public void testExceptions3()
    {
        BigRat r1 = new BigRat(5);
        r1.div(new BigRat(0));
    }
