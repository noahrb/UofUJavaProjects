...
public class MyTestCases
{
    ...
    /**
     * Throws illegalArgumentException if dataSource does not contain one or more lines.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testReadTable2 ()
    {
        GraphingMethods.readTable(new Scanner(""));
    }
    
    /**
     * Throws illegalArgumentException if dataSource contains an empty line.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Throws illegalArgumentException if dataSource has text without a tabCharacter.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testReadTable4 ()
    {
        GraphingMethods.readTable(new Scanner("Utah 28"));
    }
    
    /**
     * Throws illegalArgumentException if dataSource has text without a double literal after the tabCharacter.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testReadTable5 ()
    {
        GraphingMethods.readTable(new Scanner("Utah     "));
    }
